...
public class CONLLWriter09 extends IOGenerals {
	...
	public CONLLWriter09 (BufferedWriter outputWriter, String file) {
		
		try {
			writer = outputWriter;//new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file),"UTF8"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public CONLLWriter09(BufferedWriter outputWriter, String outfile, int formatTask) {
		this(outputWriter,outfile);
	}
